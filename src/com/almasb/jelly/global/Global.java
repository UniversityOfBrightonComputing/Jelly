...
public class Global {
    ...
    public static final Point POINT_PLAYER_DEFAULT = new Point(0, H - 2
            * SPRITE_SIZE);

    public static final int SCORE_COIN = 100;
    public static final int SCORE_BONUS = SCORE_COIN * 10;

    public static final String PATH_RESOURCES = System.getProperty("user.dir")
            + "/res/";
    ...
    public static final String APP_TITLE = "Jelly Project " + APP_VERSION
            + " | Author: " + APP_AUTHOR + " | Designer: " + APP_DESIGNER;
}
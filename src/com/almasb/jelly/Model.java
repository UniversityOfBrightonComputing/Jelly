...
public class Model extends Observable {
    /**
     * This is the only instance of player during the whole game and is
     * independent from level
     */
    public final Player player = new Player(Global.POINT_PLAYER_DEFAULT,
            GameResources.IMG_ANIMATION_PLAYER);
    ...
    /**
     * Constructs an instance and runs the thread associated with the dynamic
     * part of this model
     * 
     * @param controller
     *            - the keyboard input that will be used by game
     */

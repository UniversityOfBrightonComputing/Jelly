...
public class Renderer {
	public static BufferedImage createGraphics(String text) {
		...
		BufferedImage img = new BufferedImage(10, 10, GameResources.IMG_NULL.getType());
		
		Graphics2D g = img.createGraphics();
		Font font = new Font("Neuropol", Font.BOLD, 20);
		FontMetrics fm = g.getFontMetrics(font);
		
		img = new BufferedImage(fm.stringWidth(text), fm.getHeight(), GameResources.IMG_NULL.getType());

...
/**
 * Essentially a keyboard manipulation/input handler To use add a key listener
 * to the window with an instance of this class e.g.
...
public class KeyInput implements KeyListener {
    public enum GameEvent {
        NONE, PLAYER_MOVE_LEFT, PLAYER_MOVE_RIGHT, PLAYER_JUMP
    }

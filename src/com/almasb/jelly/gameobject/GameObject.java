...
public abstract class GameObject extends GraphicObject {
    ...
    public BufferedImage getImage() {
        return dir > 0 ? animation[animationIndex] : GraphicUtils
                .flipImage(animation[animationIndex]);
    }
    ...
    /**
     * @return - true if this object is alive, false otherwise
     */
    ...
    /**
     * Resets this object's position to where it was created
     */
    ...
    public int moveX(int dist, GameObject[] platforms) {
        ...
        Side side = dist > 0 ? Side.RIGHT : Side.LEFT; // if moving right/left
                                                       // check if right/left of
                                                       // the obj is colliding
    ...
    public void moveY(int dist, GameObject[] platforms) {
        Side side = dist > 0 ? Side.TOP : Side.BOTTOM; // if moving up/down
                                                       // check if top/bottom of
                                                       // the obj is colliding
    ...
    /**
     * @param obj
     *            - any game object against which the collision is checked

...
/**
 * A level in the game, contains all game objects read in from the text file
 * 
 * @author Almas
 * @version 0.8
 */
public class GameLevel {
    /**
     * The number of lines in the level file (from top to bottom): 1st line
     * above player 2nd line same level above ground as player 3rd line below
     * player
     * 
    ...
    /**
     * <code>value</code> - numeric value of this level 1 is the first level
     * where game starts 2 - level 2, etc
     * 
    ...
    /**
     * After this level has been initialised, this list will contain all game
    ...
    /**
     * Populates this level with objects read from the text file
     * 
     * @param lines
     *            - contains lines read from file
     */
        ...
        switch (code) {
            ...
            case Platform.ID:
                platforms.add(new Platform(x, y,
                        line == MAX_LEVEL_LINES - 1 ? PlatformType.LOWER
                                : PlatformType.UPPER));
                break;
